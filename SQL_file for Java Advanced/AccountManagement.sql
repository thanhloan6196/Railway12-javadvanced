...
CreatorID MEDIUMINT UNSIGNED NOT NULL,
Create_Date DATETIME DEFAULT NOW(),FOREIGN KEY(CategoryID) REFERENCES CategoryQuestion(CategoryID),
FOREIGN KEY(CreatorID) REFERENCES `Account`(ID)
);
...
insert into department (DepartmentName) values ('Marketing');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('lgoodge0@msn.com', 'lgoodge0', 'Lyman Goodge', 11, 3, '2017-04-09');
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('nmariansi@studiopress.com', 'nmariansi', 'Northrup Marians', 3, 3, '2019-08-28');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('nvan11@nhs.uk', 'nvan11', 'Nikolaus Van Velden', 7, 2, '2020-08-30');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('tmacneachtain1k@twitter.com', 'tmacneachtain1k', 'Teodoro MacNeachtain', 2, 1, '2018-05-12');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('wbreslin23@storify.com', 'wbreslin23', 'Wyatt Breslin', 10, 4, '2019-10-19');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('psighart2m@squarespace.com', 'psighart2m', 'Pietro Sighart', 7, 1, '2019-01-05');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('emc35@vistaprint.com', 'emc35', 'Eugenie Mc Ilwrick', 12, 3, '2019-06-23');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('agirt3o@blogtalkradio.com', 'agirt3o', 'Augie Girt', 8, 1, '2019-01-09');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('gdignon47@infoseek.co.jp', 'gdignon47', 'Gayle Dignon', 4, 3, '2019-06-11');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('lgrigsby4q@reddit.com', 'lgrigsby4q', 'Lisle Grigsby', 11, 3, '2021-02-05');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('mcantillon59@newsvine.com', 'mcantillon59', 'Melva Cantillon', 1, 3, '2019-05-30');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('hbreed5s@opensource.org', 'hbreed5s', 'Helen-elizabeth Breed', 5, 2, '2019-06-05');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('wdurnell6b@simplemachines.org', 'wdurnell6b', 'Witty Durnell', 9, 1, '2019-08-17');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
('ewoollacott6u@lycos.com', 'ewoollacott6u', 'Ev Woollacott', 11, 1, '2018-12-02');insert into account (Email, User_name, Full_Name, DepartmentID, PositionID, Create_Date) values
...
INSERT INTO `Group` ( GroupName , CreatorID , Create_Date)
...
insert into groupaccount (GroupID, ID, JoinDate) values (7, 119 , '2020-10-08');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 119 , '2019-01-27');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 190 , '2019-05-07');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 240 , '2020-06-29');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 36 , '2019-12-26');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 135 , '2019-10-10');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 160 , '2019-12-09');insert into groupaccount (GroupID, ID, JoinDate) values (5, 131 , '2019-09-26');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 85 , '2020-07-26');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 55 , '2019-06-02');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 123 , '2018-06-07');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 235 , '2018-10-15');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 140 , '2020-12-11');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 205 , '2019-03-28');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 40 , '2019-10-06');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 241 , '2018-12-14');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 218 , '2019-12-12');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 110 , '2021-01-20');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 218 , '2019-07-17');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 133 , '2020-01-27');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 133 , '2019-11-20');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 42 , '2019-04-06');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 187 , '2020-09-18');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 4 , '2019-11-26');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 241 , '2021-02-02');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 145 , '2020-03-20');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 112 , '2020-05-10');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 182 , '2018-06-14');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 97 , '2019-12-29');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 147 , '2019-09-30');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 215 , '2019-02-14');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 108 , '2020-05-27');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 81 , '2020-08-02');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 236 , '2020-12-21');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 60 , '2021-02-21');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 162 , '2018-06-13');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 15 , '2021-01-26');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 159 , '2020-09-22');insert into groupaccount (GroupID, ID, JoinDate) values (3, 125 , '2019-11-16');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 50 , '2020-02-14');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 167 , '2019-07-04');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 77 , '2019-04-20');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 109 , '2019-05-28');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 125 , '2020-09-01');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 41 , '2020-10-04');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 165 , '2019-07-19');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 195 , '2020-10-05');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 149 , '2020-01-23');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 252 , '2018-07-06');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 100 , '2019-09-09');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 206 , '2018-03-31');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 118 , '2019-12-27');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 154 , '2021-01-24');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 212 , '2019-12-03');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 185 , '2018-12-05');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 205 , '2019-10-30');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 70 , '2019-03-27');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 67 , '2020-09-15');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 37 , '2020-08-27');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 79 , '2019-02-18');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 115 , '2020-01-16');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 94 , '2019-09-22');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 163 , '2018-05-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 92 , '2018-05-16');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 80 , '2021-02-14');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 112 , '2018-09-02');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 107 , '2020-09-16');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 75 , '2019-10-01');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 89 , '2018-11-11');insert into groupaccount (GroupID, ID, JoinDate) values (10, 48 , '2018-05-05');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 209 , '2018-08-27');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 149 , '2020-11-13');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 107 , '2019-01-16');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 205 , '2018-09-12');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 246 , '2020-07-08');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 19 , '2019-02-17');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 26 , '2020-05-23');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 107 , '2019-10-25');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 56 , '2019-09-29');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 206 , '2020-07-27');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 250 , '2020-10-28');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 171 , '2020-02-20');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 137 , '2019-12-19');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 169 , '2018-08-24');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 243 , '2019-08-12');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 169 , '2020-09-11');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 63 , '2020-12-15');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 244 , '2019-12-31');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 155 , '2020-07-24');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 221 , '2019-02-10');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 54 , '2020-09-10');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 33 , '2019-09-13');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 220 , '2019-06-10');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 97 , '2020-06-23');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 97 , '2018-04-09');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 233 , '2018-03-19');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 230 , '2020-06-15');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 170 , '2018-04-29');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 78 , '2019-10-05');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 116 , '2020-11-23');insert into groupaccount (GroupID, ID, JoinDate) values (9, 60 , '2019-12-11');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 149 , '2018-12-19');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 45 , '2018-03-02');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 74 , '2018-03-11');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 174 , '2020-09-23');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 128 , '2020-03-30');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 154 , '2018-08-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 183 , '2020-01-08');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 150 , '2020-02-12');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 76 , '2020-01-14');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 106 , '2018-10-26');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 167 , '2019-06-05');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 231 , '2019-08-05');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 129 , '2018-07-20');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 151 , '2019-01-23');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 145 , '2020-06-05');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 60 , '2020-06-01');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 74 , '2020-03-10');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 75 , '2019-12-17');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 158 , '2019-03-10');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 34 , '2020-05-09');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 35 , '2019-11-02');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 120 , '2020-08-11');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 251 , '2020-05-11');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 224 , '2020-06-06');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 4 , '2018-06-11');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 186 , '2020-06-30');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 141 , '2019-02-28');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 103 , '2020-01-06');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 243 , '2021-02-20');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 13 , '2019-11-17');insert into groupaccount (GroupID, ID, JoinDate) values (5, 119 , '2020-01-22');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 56 , '2020-03-16');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 247 , '2018-12-30');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 174 , '2021-01-04');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 64 , '2021-01-31');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 155 , '2018-04-11');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 117 , '2018-12-17');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 180 , '2019-04-18');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 21 , '2018-07-21');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 154 , '2019-04-10');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 118 , '2018-10-25');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 59 , '2020-07-20');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 187 , '2018-07-02');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 114 , '2019-05-13');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 16 , '2020-02-15');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 165 , '2020-01-11');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 87 , '2020-11-15');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 34 , '2018-10-08');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 243 , '2020-01-25');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 244 , '2019-09-04');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 201 , '2019-06-20');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 199 , '2019-03-11');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 68 , '2020-08-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 88 , '2018-04-21');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 97 , '2019-11-24');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 13 , '2020-01-12');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 38 , '2018-10-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 46 , '2019-01-14');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 7 , '2019-12-05');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 164 , '2018-10-29');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 11 , '2018-07-31');insert into groupaccount (GroupID, ID, JoinDate) values (10, 156 , '2019-07-14');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 94 , '2019-08-31');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 210 , '2021-01-23');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 42 , '2020-03-27');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 109 , '2019-01-13');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 215 , '2019-09-16');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 79 , '2020-07-14');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 183 , '2019-10-26');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 231 , '2020-05-08');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 85 , '2019-12-04');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 127 , '2019-06-12');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 123 , '2020-10-19');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 172 , '2018-11-21');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 207 , '2019-01-26');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 19 , '2020-09-02');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 250 , '2020-09-05');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 221 , '2020-06-16');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 45 , '2020-05-15');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 54 , '2018-03-12');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 239 , '2020-06-13');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 158 , '2020-12-18');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 2 , '2019-09-01');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 230 , '2020-03-24');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 137 , '2019-02-09');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 223 , '2020-10-10');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 53 , '2019-08-15');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 152 , '2019-08-07');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 244 , '2019-12-15');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 19 , '2018-09-09');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 243 , '2019-05-20');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 186 , '2020-04-05');insert into groupaccount (GroupID, ID, JoinDate) values (9, 253 , '2020-01-05');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 204 , '2020-07-04');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 172 , '2018-06-30');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 123 , '2019-11-25');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 131 , '2018-07-03');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 66 , '2020-11-05');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 214 , '2018-05-13');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 182 , '2020-03-04');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 82 , '2021-02-18');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 156 , '2020-10-09');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 89 , '2019-07-20');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 233 , '2018-10-31');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 121 , '2020-02-26');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 238 , '2019-10-13');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 179 , '2019-02-03');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 12 , '2021-01-14');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 166 , '2019-07-26');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 88 , '2020-12-01');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 53 , '2020-12-09');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 40 , '2020-04-01');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 222 , '2019-06-07');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 31 , '2019-06-17');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 100 , '2021-01-16');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 107 , '2019-04-25');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 253 , '2020-11-30');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 249 , '2020-03-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 167 , '2018-08-12');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 44 , '2021-02-03');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 70 , '2020-08-22');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 205 , '2018-04-26');
insert into groupaccount (GroupID, ID, JoinDate) values (5, 181 , '2019-04-08');insert into groupaccount (GroupID, ID, JoinDate) values (7, 30 , '2020-04-12');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 241 , '2021-02-23');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 232 , '2019-02-05');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 120 , '2019-04-26');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 130 , '2020-10-13');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 39 , '2020-01-01');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 240 , '2019-01-05');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 62 , '2019-02-06');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 180 , '2018-08-11');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 171 , '2018-11-27');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 168 , '2019-07-02');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 84 , '2020-11-29');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 14 , '2020-07-17');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 56 , '2020-11-17');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 191 , '2021-02-24');
insert into groupaccount (GroupID, ID, JoinDate) values (4, 160 , '2021-02-05');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 133 , '2020-01-28');
insert into groupaccount (GroupID, ID, JoinDate) values (1, 92 , '2018-03-23');
insert into groupaccount (GroupID, ID, JoinDate) values (3, 126 , '2019-07-13');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 216 , '2020-04-25');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 157 , '2020-04-22');
insert into groupaccount (GroupID, ID, JoinDate) values (2, 184 , '2020-04-29');
insert into groupaccount (GroupID, ID, JoinDate) values (6, 40 , '2019-09-21');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 217 , '2020-10-26');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 127 , '2018-06-27');
insert into groupaccount (GroupID, ID, JoinDate) values (9, 50 , '2020-08-25');
insert into groupaccount (GroupID, ID, JoinDate) values (7, 238 , '2020-04-23');
insert into groupaccount (GroupID, ID, JoinDate) values (10, 166 , '2020-12-22');
insert into groupaccount (GroupID, ID, JoinDate) values (8, 249 , '2019-07-31');
...
('C Sharp' ),
('PHP' );
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
7641 zR2', 10, 2, 158, '2019-07-15');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
5574 ndU', 4, 1, 3, '2019-03-25');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
4063 p06', 6, 2, 161, '2019-08-25');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
6415 r3P', 9, 2, 38, '2020-07-18');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
8762 spH', 2, 2, 193, '2019-07-26');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
4969 v2Z', 5, 2, 119, '2018-04-09');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
8893 beL', 1, 1, 97, '2020-04-22');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
7547 qTA', 3, 1, 192, '2019-07-29');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
4434 oh7', 3, 1, 230, '2018-05-03');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
9520 qwJ', 10, 1, 19, '2019-11-26');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
0252 fd1', 6, 2, 170, '2021-02-15');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
3880 t30', 2, 2, 205, '2019-10-27');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
4484 vOR', 2, 1, 73, '2019-04-21');insert into Question (Content, CategoryID, TypeID, CreatorID, Create_Date) values ('Question VTI
...
, Duration , CreatorID , Create_Date )
